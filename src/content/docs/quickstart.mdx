...
<CardGrid>
  ...
  <Card title="29 languages" icon="translate">
...
<Aside type="tip" title="FREE for Claude Code CLI Users">
If you're using Claude Code CLI or Codex CLI, you can enable Code Research at **no additional cost** using your existing subscription. Just add one line to your config!
</Aside>
...
See the [Code Research Setup](/code-research#setup-configuration) guide for detailed configuration instructions.
